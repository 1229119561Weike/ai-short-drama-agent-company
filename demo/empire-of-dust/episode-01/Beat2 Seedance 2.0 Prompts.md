...
**Time:** `0:15-0:30`  
**Location:** Same funeral court

**Visual**

The pike stops when Cael catches it bare-handed and snaps it aside, black cloak cutting across the white funeral geometry.

**Dialogue Burst**

- Cael: `Don't scream.`
- Lyra: `You first.`
- Cael: `You died twelve minutes ago.`
- Lyra: `Then someone failed.`
- Cael: `No. Someone succeeded too early.`
**Info Payload**

- Cael expected this possibility
- Lyra's death is recent, not ancient
- her murder may be part of a timetable

**SFX / BGM**

- Pike fracture
- Alarm seed tone under funeral music
- `BGM_A_BLACK_SUN_LITURGY` + sub pulse
...
- `SHOT_PROMPT`:
```text
9:16 premium cinematic protector reveal, war prince snapping plasma pike aside and kneeling beside revived empress at own funeral, black cloak against white stone funeral court, cold urgency, danger and alliance in one image.
```

**Mini-Hook**

Lyra sees blood on his hand that is not his.
