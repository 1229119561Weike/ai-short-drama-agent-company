...
**Time:** `0:45-1:00`  
**Location:** Funeral evacuation route

**Visual**

Sevra rises without enough surprise and orders the body secured while Cael pulls Lyra into an alarm-lit corridor.

**Dialogue Burst**

- Sevra: `Seal the court. Recover the body.`
- Lyra: `Body? Not empress?`
- Cael: `Don't stop walking.`
- Lyra: `Why are they chasing my body?`
- Cael: `Because your killer is still in the room.`
**Info Payload**

- the regime is using depersonalized body language
- Sevra is too composed
- the season's core murder mystery is set

**SFX / BGM**

- Corridor alarm
- Boots on polished stone
- `BGM_G_SOVEREIGN_BURN`

**Compact Consistency Prompt**

- `SCENE_ID`: `E01_B4`
- `CAST_LOCK`: `LYRA_V1 ; CAEL_V1 ; SEVRA_V1`
- `LOOK_LOCK`: `LYRA_L01 ; CAEL_L01 ; SEVRA_L01`
- `ENV_LOCK`: `ENV_FUNERAL_COURT`
- `LOCK_CORE`
- `NEG_CORE`
- `SHOT_PROMPT`:
```text
9:16 premium cinematic escape cliffhanger, regent rising at funeral with suspicious control while war prince drags revived empress into alarm-lit corridor and tells her killer is still in the room, white-black-gold imperial panic, hard episode ending.
```

**Episode Cliffhanger**

Cut to black on Lyra realizing the hunt has already started.
