...
**Time:** `0:30-0:45`  
**Location:** Funeral court edge

**Visual**

Cael drags Lyra from the bier while hidden recording drones bloom from the pillars. In the black water she sees the flash-memory: a ceremonial needle entering below her collarbone.

**Dialogue Burst**

- Lyra: `Needle. Below the collarbone.`
- Cael: `Good. Hold the memory.`
- Lyra: `You know the wound.`
- Cael: `I know the weapon.`
- Lyra: `Then you know the killer.`
**Info Payload**

- Lyra remembers the murder mechanism
- Cael knows more than he admits
- the funeral was under surveillance
...
- `LOOK_LOCK`: `LYRA_L01 ; CAEL_L01`
- `ENV_LOCK`: `ENV_FUNERAL_COURT`
- `LOCK_CORE`
- `NEG_CORE`
- `SHOT_PROMPT`:
```text
9:16 premium cinematic murder-flash beat, revived empress pulled from funeral bier while hidden recording drones open from pillars, mirror-black water reflecting ceremonial needle entering below her collarbone, elegant assassination clue, highly legible.
```

**Mini-Hook**

She was murdered in full ritual view.
