...
**Time:** `0:45-1:00`  
**Location:** Desert cliff drop

**Visual**

Cael drives straight off a cliff into a sand-fall canyon while drones fire. Lyra grabs his arm as the crawler drops into gold dust.

**Dialogue Burst**

- Lyra: `Are you insane?`
- Cael: `Strategic.`
- Lyra: `That wasn't strategy.`
(Cael smiles.)
- Cael: `Now you're alive enough to be frightened.`
**Info Payload**

- Cael uses fear as calibration
- their dynamic turns from rescue to violent trust-building
- the episode ends on character voltage, not just action
...
- Hull scream
- Sand avalanche
- `BGM_B_DESERT_VELOCITY` cut to sub drop
...
- `SHOT_PROMPT`:
```text
9:16 premium cinematic cliff-drop topper, pursuit drones firing as war prince drives crawler straight into sand-fall canyon and revived empress grabs his arm mid-fall, beautiful terror, smile line at the end, maximum retention action finish.
```

**Episode Cliffhanger**

He may be insane. He may be saving her. Possibly both.
