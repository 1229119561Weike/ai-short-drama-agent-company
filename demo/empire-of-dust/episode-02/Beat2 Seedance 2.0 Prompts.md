...
**Time:** `0:15-0:30`  
**Location:** Moving crawler cockpit

**Visual**

Wanted alerts flood the windshield: `EMPRESS BODY COMPROMISED`. Drones descend through dust behind them.

**Dialogue Burst**

- Lyra: `Body?`
- Cael: `Read the phrasing carefully.`
- Lyra: `They don't care if I'm conscious.`
- Cael: `They care about what's inside you.`
- Lyra: `Then what exactly am I carrying?`
**Info Payload**

- the state is hunting the vessel, not the person
- something valuable is in Lyra's body
- the threat is institutional, not emotional

**SFX / BGM**

- HUD chirps
- Drone ignition
- `BGM_B_DESERT_VELOCITY` with sub pulse

**Compact Consistency Prompt**

- `SCENE_ID`: `E02_B2`
- `CAST_LOCK`: `LYRA_V1 ; CAEL_V1`
- `LOOK_LOCK`: `LYRA_L02 ; CAEL_L01`
- `ENV_LOCK`: `ENV_ECLIPSE_DESERT`
- `LOCK_CORE`
- `NEG_CORE`
- `SHOT_PROMPT`:
```text
9:16 premium cinematic body-hunt reveal, wanted holograms flooding crawler glass with EMPRESS BODY COMPROMISED while pursuit drones descend through dust behind fleeing war prince and revived empress, clean urgent exposition, instantly understandable.
```

**Mini-Hook**

The empire doesn't want justice. It wants retrieval.
