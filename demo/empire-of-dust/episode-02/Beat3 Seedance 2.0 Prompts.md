...
**Time:** `0:30-0:45`  
**Location:** Same crawler / cliff turn

**Visual**

Sevra announces Lyra dead and names Auren acting ruler. Auren's face appears in transmission — elegant, frightened, and visibly unready.

**Dialogue Burst**

- Sevra: `Until eclipse resolution, Auren Sol will hold succession authority.`
- Lyra: `He looks terrified.`
- Cael: `Good. Terror is proof of surprise.`
- Lyra: `So he didn't order my death.`
- Cael: `Or he ordered it badly.`
**Info Payload**

- suspicion shifts away from Auren as sole mastermind
- Auren may be pawn, not architect
- Cael keeps multiple possibilities alive

**SFX / BGM**

- Broadcast distortion
- Suspension rattle
- `BGM_C_PALACE_GLASS` ghosted into `BGM_B_DESERT_VELOCITY`

**Compact Consistency Prompt**

- `SCENE_ID`: `E02_B3`
- `CAST_LOCK`: `LYRA_V1 ; CAEL_V1 ; AUREN_V1 ; SEVRA_V1`
- `LOOK_LOCK`: `LYRA_L02 ; CAEL_L01 ; AUREN_L01 ; SEVRA_L01`
- `ENV_LOCK`: `ENV_ECLIPSE_DESERT`
- `LOCK_CORE`
- `NEG_CORE`
- `SHOT_PROMPT`:
```text
9:16 premium cinematic succession reveal, imperial broadcast naming golden heir temporary ruler while revived empress watches from fleeing desert crawler and realizes he looks scared rather than victorious, sharp political reset, gorgeous high-future clarity.
```

**Mini-Hook**

If Auren didn't want her dead, someone else did.
