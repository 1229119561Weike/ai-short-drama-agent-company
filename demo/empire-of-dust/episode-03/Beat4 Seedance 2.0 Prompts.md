...
**Time:** `0:45-1:00`  
**Location:** Obsidian reflection wall

**Visual**

In the obsidian wall behind him, the black-glass needle case aligns perfectly with the wound under Lyra's skin. In one reflected frame, rescuer and murder tool occupy the same silhouette.

**Dialogue Burst**

- Lyra: `If you're lying, I'll outlive you first.`
- Cael: `Good.`
- Lyra: `That's not reassuring.`
- Cael: `I wasn't reaching for reassuring.`
- Lyra: `Were you there when I died?`
- Cael: `Yes.`
- Lyra: `Close enough to touch me?`
- Cael: `Yes.`
**Info Payload**

- Cael was physically present at Lyra's death
- Lyra now has reason to suspect both rescue and complicity
- Cael refuses self-defense beyond bare facts

**SFX / BGM**

- Light glass resonance
- Reflection tone smear
- `BGM_E_MEMORY_KNIFE` + heartbeat sub throb
...
- `ENV_LOCK`: `ENV_PALACE_SPINE`
- `LOCK_CORE`
- `NEG_CORE`
- `SHOT_PROMPT`:
```text
9:16 premium cinematic suspicion cliffhanger, empress seeing black-glass needle case reflected beside war prince in obsidian palace wall and deciding he may be both rescuer and accomplice, elegant mirror image, hard ending question.
```

**Episode Cliffhanger**

The man saving her admits he was close enough to kill her.
