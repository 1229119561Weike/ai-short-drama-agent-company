...
**Time:** `0:00-0:15`  
**Location:** Suspended recovery chamber in the Palace Spine

**Visual**

Lyra rips awake mid-spasm as geometric light punches beneath the healed skin at her collarbone. The medical shell opens around her like a flower made of ivory blades while the city hangs thousands of feet below.

**Dialogue Burst**

- Lyra: `What did you put in me?`
- Cael (O.S.): `Not me.`
- Lyra: `Then who closed the wound?`
- Cael: `The machine did.`
(Lyra touches the pulse.)
- Lyra: `It's moving.`
- Cael: `Yes. That's the problem.`
**Info Payload**

- the wound is active, not healed
- something mechanical is alive under her skin
- Cael already knows it is dangerous

**SFX / BGM**

- Medical pulse stabs
- Chamber petals unlock
- Glass-floor wind pressure
- `BGM_C_PALACE_GLASS` + sharp synthetic arpeggio + sub pulse
...
- `SHOT_PROMPT`:
```text
9:16 premium cinematic medical-hook opener, revived empress waking in suspended ivory chamber above cloud city with healed wound at collarbone pulsing with hidden machine geometry under skin, beautiful luxury future hospital dread, immediate body mystery.
```

**Mini-Hook**

The murder weapon is still inside her.
