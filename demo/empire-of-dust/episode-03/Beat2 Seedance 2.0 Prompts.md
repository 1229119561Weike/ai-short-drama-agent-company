...
**Time:** `0:15-0:30`  
**Location:** Same chamber

**Visual**

Cael steps in holding the black-glass ceremonial needle case. He scans her wound and the exact same geometry blooms in the air between them like a verdict.

**Dialogue Burst**

- Lyra: `Did you put it there?`
- Cael: `No.`
- Lyra: `That answer was too clean.`
- Cael: `You prefer guilty men who stutter?`
- Lyra: `I prefer innocent men who don't own the weapon.`
(Cael lifts the case.)
- Cael: `I own the case.`
- Lyra: `That's not helping.`
**Info Payload**

- Cael denies direct responsibility
- Cael possessed the murder instrument housing
- Lyra's suspicion becomes direct and rational

**SFX / BGM**

- Scan tone
- Glass click
- Wound resonance buzz
- `BGM_C_PALACE_GLASS` + `BGM_E_MEMORY_KNIFE` + rapid pulse percussion
...
- `SHOT_PROMPT`:
```text
9:16 premium cinematic accusation beat, war prince scanning revived empress wound with same black-glass ceremonial needle case seen in murder flash, machine pattern match under skin, direct suspicion between them, extremely clear and tense.
```

**Mini-Hook**

He owns the case that matches the murder.
