...
**Time:** `0:30-0:45`  
**Location:** Observation ledge above void hangar

**Visual**

Cael forces the chamber wall transparent and reveals a cathedral-scale void hangar full of carrier ships suspended in dust-light. He points to an entire wing he moved to steal her body from the funeral.

**Dialogue Burst**

- Lyra: `How many ships did you move?`
- Cael: `Enough.`
- Lyra: `That is not a number.`
- Cael: `It is a treason category.`
- Lyra: `Why risk an entire wing for one corpse?`
- Cael: `Because you were never just a corpse.`
- Lyra: `Then what am I?`
- Cael: `Still deciding whether to tell you.`
**Info Payload**

- Cael's rescue operation was massive
- Lyra's body has military-scale value
- Cael knows more than he will yet disclose

**SFX / BGM**

- Hangar wind
- Carrier stabilizer hum
- Distant engine choir
- `BGM_C_PALACE_GLASS` + low brass ascent

**Compact Consistency Prompt**

- `SCENE_ID`: `E03_B3`
- `CAST_LOCK`: `LYRA_V1 ; CAEL_V1`
- `LOOK_LOCK`: `LYRA_L03 ; CAEL_L02`
- `ENV_LOCK`: `ENV_VOID_HANGAR`
- `LOCK_CORE`
- `NEG_CORE`
- `SHOT_PROMPT`:
```text
9:16 premium cinematic treason reveal, revived empress on palace ledge above cathedral-scale void hangar learning war prince moved entire carrier wing illegally to steal her body from her own funeral, scale and betrayal in one frame.
```

**Mini-Hook**

He risked military mutiny to steal her body.
